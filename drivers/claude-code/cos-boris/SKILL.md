...
Read `~/cognitive-os/protocols/boris.md` for the full methodology.
...
- **Architecture:** Code, docs, competitors, benchmarks, prior decisions in `~/cognitive-os/decisions.md`.
...
### 8. Check for Insight
- Does this finding match patterns in `~/cognitive-os/insight.md`?
